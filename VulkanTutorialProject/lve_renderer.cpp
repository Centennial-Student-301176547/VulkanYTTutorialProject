...
namespace lve {
    ...
    void LveRenderer::recreateSwapChain() {
        ...
        if (lveSwapChainPtr == nullptr) {
            ...
            std::shared_ptr<LveSwapChain> oldSwapChain = std::move(lveSwapChainPtr);
            lveSwapChainPtr = std::make_unique<LveSwapChain>(lveDevice, extent, oldSwapChain);

            if (!oldSwapChain->compareSwapFormats(*lveSwapChainPtr.get())) {
    ...
    VkCommandBuffer LveRenderer::beginFrame() {
        ...
        auto result = lveSwapChainPtr->acquireNextImage(&currentImageIndex);
    ...
    void LveRenderer::endFrame() {
        ...
        auto result = lveSwapChainPtr->submitCommandBuffers(&commandBuffer, &currentImageIndex);
    ...
    void LveRenderer::beginSwapChainRenderPass(VkCommandBuffer commandBuffer) {
        ...
        renderPassInfo.framebuffer = lveSwapChainPtr->getFrameBuffer(currentImageIndex);
